...
export const Styles = ({
    ...
    const variantStyles = {
        ...
        secondary: {
            ...
            text: 'text-cia-gray-dark hover:text-white',
        ...
        tertiary: {
            ...
            text: 'text-cia-purpleBlue-main',
            border: 'border border-cia-grey-light',
            active: 'active:bg-activeBTGradient',
            disabled: 'disabled:bg-[#E9E9FF] disabled:text-[#ACA9E3]',
        },
        transparent: {
            base: baseStyles,
            background: 'bg-transparent',
            text: 'text-cia-grey-dark',
            border: 'border-none',
